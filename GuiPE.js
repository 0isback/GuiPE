 ...
 * @memberOf GuiPE
 */
GuiPE.getMCPEVersion = function () {
	return ModPE.getMinecraftVersion().split(".")[1];
};
...
/**
 * 마인크래프트가 최신버전인지 확인합니다
 */
GuiPE.isUpdated = function () {
	return (GuiPE.getMCPEVersion() < 16) ? false : true;
};
...
FontPE.getDefaultImage = function (str, color) {
    ...
    if (typeof FontPE.cache["default"] !== "object") {
        default8 = GuiPE.isUpdated() ? GuiPE.getImage("resourcepacks/vanilla/client/font/default8.png") : GuiPE.getImage("images/font/default8.png");
    ...
    for (var i = 0; i < LEN; i ++) {
        ...
        if (char === 32) { //space
            ...
            if (typeof FontPE.cache[hex] !== "object") {
                glyph = GuiPE.isUpdated() ? GuiPE.getImage("resourcepacks/vanilla/client/font/glyph_"+hex+".png") : GuiPE.getImage("images/font/glyph_"+hex+".png");
